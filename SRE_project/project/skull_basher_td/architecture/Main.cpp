...
//        std::shared_ptr<Animation> launch = std::make_shared<Animation>(true);
//        launch->addFrame(glm::vec3(0), glm::vec3(1), glm::vec3(-90, 0, 0), 1.f);
//        armAN->addAnimation("launch", launch);
//        armAN->setAnimationState("launch");
//
//
//        catapult->getComponent<Transform>()->rotation = glm::vec3{45, 0, 0};
//        arm->getComponent<Transform>()->rotation = glm::vec3{45, 0, 0};
//        catapult->getComponent<Transform>()->scale = glm::vec3{0.8f};
//        arm->getComponent<Transform>()->scale = glm::vec3{0.8f};
//        armMR->getModel()->setTransform(glm::translate(glm::vec3(0, 1, -0.4)));
//
